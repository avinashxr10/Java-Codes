    ...
    <section id="table_of_contents">
        ...
        <div id="_table_of_contents">
            <ul>
                ...
                <li><a href="#files-included-in-package">Files included in package</a></li>
...
Sets tag 'latest' if no --tag specified
        ...
        <ul>
            ...
            <li>
                <p><code>[--tag &lt;tag&gt;]</code>: Registers the published package with the given tag, such
                    ...
                    <code>npm publish</code> updates and <code>npm install</code> installs the <code>latest</code> tag.
                    See
        ...
        <p>Similar to <code>--dry-run</code> see <a href="../commands/npm-pack.html"><code>npm pack</code></a>, which
            figures
        ...
        <ul>
            ...
            <li>
                <p>If the file matches certain patterns, then it will <em>never</em> be included,
                    ...
                    un-ignored with a <code>!</code> rule in a <code>.npmignore</code> or <code>.gitignore</code> file.
                </p>
            </li>
            <li>
