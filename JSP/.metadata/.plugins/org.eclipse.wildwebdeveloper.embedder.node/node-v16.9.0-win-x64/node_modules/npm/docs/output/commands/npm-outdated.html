    ...
    <div id="_content"><h3 id="synopsis">Synopsis</h3>
        ...
        <ul>
            ...
            <li><code>latest</code> is the version of the package tagged as latest in the registry.
                ...
                <a href="../commands/npm-dist-tag.html">dist-tag</a>.
            </li>
            ...
            <li><code>package type</code> (when using <code>--long</code> / <code>-l</code>) tells you whether this
                ...
                included in <code>package.json</code> are always marked <code>dependencies</code>.
            </li>
            <li><code>homepage</code> (when using <code>--long</code> / <code>-l</code>) is the <code>homepage</code>
                value contained
...
once           1.3.2    1.3.3    1.3.3  node_modules/once         dependent-package-name
  ...
  "once": "^1.3.1"
        ...
        <ul>
            <li><code>glob</code> requires <code>^5</code>, which prevents npm from installing <code>glob@6</code>,
                which
            ...
            <li><code>npm@3.5.2</code> is marked as “wanted”, but “latest” is <code>npm@3.5.1</code> because
                ...
                (with no semver range) will install whatever’s tagged as <code>latest</code>.
            </li>
            <li><code>once</code> is just plain out of date. Reinstalling <code>node_modules</code> from
                scratch or running <code>npm update</code> will bring it up to spec.
            </li>
        </ul>
