    ...
    <section id="table_of_contents">
        ...
        <div id="_table_of_contents">
            <ul>
                ...
                <li><a href="#npx-vs-npm-exec"><code>npx</code> vs <code>npm exec</code></a></li>
                ...
                <li><a href="#workspaces-support">Workspaces support</a></li>
                <ul>
                    <li><a href="#filtering-workspaces">Filtering workspaces</a></li>
                </ul>
                <li><a href="#compatibility-with-older-npx-versions">Compatibility with Older npx Versions</a></li>
                <li><a href="#a-note-on-caching">A note on caching</a></li>
                <ul>
                    <li><a href="#prefer-online">prefer-online</a></li>
                    <li><a href="#prefer-offline">prefer-offline</a></li>
                    <li><a href="#offline">offline</a></li>
                    <li><a href="#workspace2">workspace</a></li>
                    <li><a href="#workspaces2">workspaces</a></li>
                </ul>
...
-c &lt;cmd&gt; --call=&lt;cmd&gt; (may not be mixed with positional arguments)
        ...
        <ul>
            ...
            <li>If the package has multiple <code>bin</code> entries, and one of them matches the
                unscoped portion of the <code>name</code> field, then that command will be used.
            </li>
            <li>If this does not result in exactly one option (either because there are
                ...
                <code>npm exec</code> exits with an error.
            </li>
        </ul>
    ...
    "workspaces": [ "./packages/*" ]
        ...
        <ul>
            ...
            <li>To prevent security and user-experience problems from mistyping package
                ...
                prompt with the <code>-y</code> or <code>--yes</code> option.
            </li>
            ...
            <li>The <code>--ignore-existing</code> option is removed. Locally installed bins are
                always present in the executed process <code>PATH</code>.
            </li>
            ...
            <li>The <code>--shell</code> option is replaced with <code>--script-shell</code>, but maintained
                in the <code>npx</code> executable for backwards compatibility.
            </li>
        </ul>
