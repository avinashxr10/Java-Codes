...
<section id="content">
    ...
    <section id="table_of_contents">
        ...
        <div id="_table_of_contents">
            <ul>
                ...
                <li><a href="#package-lockjson-vs-npm-shrinkwrapjson"><code>package-lock.json</code> vs <code>npm-shrinkwrap.json</code></a>
                </li>
                <li><a href="#hidden-lockfiles">Hidden Lockfiles</a></li>
                <li><a href="#handling-old-lockfiles">Handling Old Lockfiles</a></li>
                <li><a href="#file-format">File Format</a></li>
                <ul>
                    <li><a href="#name"><code>name</code></a></li>
                    <li><a href="#version"><code>version</code></a></li>
                    <li><a href="#lockfileversion"><code>lockfileVersion</code></a></li>
    ...
    <div id="_content"><h3 id="description">Description</h3>
        ...
        <h3 id="package-lockjson-vs-npm-shrinkwrapjson"><code>package-lock.json</code> vs
            <code>npm-shrinkwrap.json</code></h3>
        ...
        <ul>
            ...
            <li>
                <p>integrity: A <code>sha512</code> or <code>sha1</code> <a
                        href="https://w3c.github.io/webappsec/specs/subresourceintegrity/">Standard Subresource
                    Integrity</a>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>git sources: This is a git specifier with resolved committish. (eg,
                        <code>git+https://example.com/foo/bar#115311855adb0789a0466714ed48a1499ffea97e</code>)
                    </li>
                    ...
                    <li>local link sources: This is the file URL of the link. (eg
                        <code>file:libs/our-module</code>)
                    </li>
                </ul>
            </li>
            <li>
