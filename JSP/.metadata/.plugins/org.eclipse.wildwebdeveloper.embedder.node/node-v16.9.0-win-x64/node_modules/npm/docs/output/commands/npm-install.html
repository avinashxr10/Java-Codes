...
common options: [-P|--save-prod|-D|--save-dev|-O|--save-optional|--save-peer] [-E|--save-exact] [-B|--save-bundle] [--no-save] [--dry-run]
        ...
        <ul>
            <li>a) a folder containing a program described by a
                <a href="../configuring-npm/package-json.html"><code>package.json</code></a> file
            </li>
            <li>b) a gzipped tarball containing (a)</li>
            <li>c) a url that resolves to (b)</li>
            <li>d) a <code>&lt;name&gt;@&lt;version&gt;</code> that is published on the registry (see
                <a href="../using-npm/registry.html"><code>registry</code></a>) with (c)
            </li>
            <li>e) a <code>&lt;name&gt;@&lt;tag&gt;</code> (see <a href="../commands/npm-dist-tag.html"><code>npm
                dist-tag</code></a>) that
                points to (d)
            </li>
        ...
        <ul>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>The package contents should reside in a subfolder inside the tarball
                        ...
                        when installing the package (an equivalent of <code>tar x --strip-components=1</code> is run).
                    </li>
            ...
            <li>
                ...
                <p>Do a <code>&lt;name&gt;@&lt;tag&gt;</code> install, where <code>&lt;tag&gt;</code> is the “tag”
                    config. (See
                    <a href="../using-npm/config.html"><code>config</code></a>. The config’s default value is <code>latest</code>.)
                </p>
...
npm install ansi-regex --save-bundle
            ...
            <li>
                ...
                <p>Install a package under a custom alias. Allows multiple versions of
                    ...
                    <a href="https://www.npmjs.com/package/validate-npm-package-name#naming-rules"><code>validate-npm-package-name</code></a>.
                </p>
                <p>Examples:</p>
...
npm install github:mygithubuser/myproject
            ...
            <li>
                <p><code>npm install gist:[&lt;githubname&gt;/]&lt;gistID&gt;[#&lt;commit-ish&gt;|#semver:&lt;semver&gt;]</code>:
                </p>
            ...
            <li>
                <p><code>npm install bitbucket:&lt;bitbucketname&gt;/&lt;bitbucketrepo&gt;[#&lt;commit-ish&gt;]</code>:
                </p>
                ...
                <p>If <code>#&lt;commit-ish&gt;</code> is provided, it will be used to clone exactly that
                    ...
                    registry dependency. If neither <code>#&lt;commit-ish&gt;</code> or
                    <code>#semver:&lt;semver&gt;</code> is
