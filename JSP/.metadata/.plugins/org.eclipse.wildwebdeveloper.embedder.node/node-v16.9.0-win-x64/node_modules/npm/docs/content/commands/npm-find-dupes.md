---
title: npm-find-dupes section: 1 description: Find duplication in the package tree
---
...
Runs `npm dedupe` in `--dry-run` mode, making npm only output the duplications, without actually changing the package
tree.
