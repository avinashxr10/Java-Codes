    ...
    <section id="table_of_contents">
        ...
        <div id="_table_of_contents">
            <ul>
                ...
                <li><a href="#note-design-changes-pending">Note: Design Changes Pending</a></li>
...
└─┬ init-package-json@0.0.4
  └── promzard@0.1.5
        ...
        <p>Also, in the years since npm got an <code>ls</code> command (in version 0.0.2!),
            ...
            order to avoid dumping an excessive amount of content to the terminal, <code>npm ls</code> now only shows
            the <em>top</em> level dependencies, unless <code>--all</code> is
            provided.</p>
