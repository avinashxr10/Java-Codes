    ...
    <section id="table_of_contents">
        ...
        <div id="_table_of_contents">
            <ul>
                ...
                <li><a href="#developer-usage">Developer Usage</a></li>
                <ul>
    ...
    <div id="_content"><h3 id="synopsis">Synopsis</h3>
        ...
        <ul>
            <li>json:
                ...
                <a href="../configuring-npm/package-json.html"><code>package.json</code></a>.
            </li>
            <li>link:
                Links your current working code into Node’s path, so that you don’t
                have to reinstall every time you make a change. Use <a href="../commands/npm-link.html"><code>npm
