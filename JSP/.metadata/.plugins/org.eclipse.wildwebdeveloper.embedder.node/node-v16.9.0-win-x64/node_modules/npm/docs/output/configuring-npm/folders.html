...
<section id="content">
        ...
        <div id="_table_of_contents">
            <ul>
                ...
                <ul>
                    ...
                    <li><a href="#temp-files">Temp Files</a></li>
                </ul>
                <li><a href="#more-information">More Information</a></li>
                <ul>
                    <li><a href="#global-installation">Global Installation</a></li>
                    <li><a href="#cycles-conflicts-and-folder-parsimony">Cycles, Conflicts, and Folder Parsimony</a>
                    </li>
    ...
    <div id="_content"><h3 id="description">Description</h3>
        ...
        <p>See <a href="../commands/npm-cache.html"><code>npm cache</code></a>. Cache files are stored in
            <code>~/.npm</code> on Posix, or
...
+-- node_modules
    ...
    `-- baz (1.2.3) &lt;---[D]
        ...
        <p>This allows a package maintainer to install all of their dependencies
            ...
            cannot be found elsewhere. See <a href="../configuring-npm/package-json.html"><code>package.json</code></a>
