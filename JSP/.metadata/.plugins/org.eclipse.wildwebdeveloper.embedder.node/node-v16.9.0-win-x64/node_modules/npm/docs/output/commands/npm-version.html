...
'npm ls' to inspect current package/dependency versions
        ...
        <p>The <code>newversion</code> argument should be a valid semver string, a valid second
            ...
            of <code>patch</code>, <code>minor</code>, <code>major</code>, <code>prepatch</code>, <code>preminor</code>,
            <code>premajor</code>,
...
Enter passphrase:
        ...
        <ol>
            ...
            <li>Run the <code>preversion</code> script. These scripts have access to the old
                ...
                should be explicitly added using <code>git add</code>.
            </li>
            <li>Bump <code>version</code> in <code>package.json</code> as requested (<code>patch</code>,
                <code>minor</code>,
                <code>major</code>, etc).
            </li>
            <li>Run the <code>version</code> script. These scripts have access to the new <code>version</code>
                ...
                generated files to the commit using <code>git add</code>.
            </li>
