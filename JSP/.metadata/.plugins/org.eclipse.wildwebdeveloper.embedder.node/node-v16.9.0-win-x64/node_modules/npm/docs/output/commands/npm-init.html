    ...
    <section id="table_of_contents">
        ...
        <div id="_table_of_contents">
            <ul>
                ...
                <ul>
                    <li><a href="#forwarding-additional-options">Forwarding additional options</a></li>
                </ul>
...
npm init [-w &lt;dir&gt;] [args...]
        ...
        <p>Any additional options will be passed directly to the command, so <code>npm init foo -- --hello</code> will
            map to <code>npm exec -- create-foo --hello</code>.</p>
