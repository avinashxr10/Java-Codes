...
<section id="content">
    ...
    <section id="table_of_contents">
        ...
        <div id="_table_of_contents">
            <ul>
                ...
                <li><a href="#does-npm-send-any-information-about-me-back-to-the-registry">Does npm send any information
                    about me back to the registry?</a></li>
                <li><a href="#how-can-i-prevent-my-package-from-being-published-in-the-official-registry">How can I
                    prevent my package from being published in the official registry?</a></li>
                <li><a href="#where-can-i-find-my-own--others-published-packages">Where can I find my own, &amp;
                    other’s, published packages?</a></li>
    ...
    <div id="_content"><h3 id="description">Description</h3>
        ...
        <p>npm is configured to use the <strong>npm public registry</strong> at
            <a href="https://registry.npmjs.org">https://registry.npmjs.org</a> by default. Use of the npm public
            registry is
            subject to terms of use available at <a href="https://docs.npmjs.com/policies/terms">https://docs.npmjs.com/policies/terms</a>.
        </p>
        ...
        <p>The npm public registry is powered by a CouchDB database,
            of which there is a public mirror at <a href="https://skimdb.npmjs.com/registry">https://skimdb.npmjs.com/registry</a>.
        </p>
        <p>The registry URL used is determined by the scope of the package (see
            ...
            used, which is
            supplied by the <code>registry</code> config parameter. See <a href="../commands/npm-config.html"><code>npm
                config</code></a>,
            <a href="../configuring-npm/npmrc.html"><code>npmrc</code></a>, and <a
                    href="../using-npm/config.html"><code>config</code></a> for more on managing npm’s configuration.
        </p>
        <h3 id="does-npm-send-any-information-about-me-back-to-the-registry">Does npm send any information about me back
            to the registry?</h3>
        <p>Yes.</p>
        ...
        <h3 id="how-can-i-prevent-my-package-from-being-published-in-the-official-registry">How can I prevent my package
            from being published in the official registry?</h3>
        ...
        <p>See <a href="../configuring-npm/package-json.html"><code>package.json</code></a> for more info on what goes
            in the package.json file.</p>
        <h3 id="where-can-i-find-my-own--others-published-packages">Where can I find my own, &amp; other’s, published
            packages?</h3>
