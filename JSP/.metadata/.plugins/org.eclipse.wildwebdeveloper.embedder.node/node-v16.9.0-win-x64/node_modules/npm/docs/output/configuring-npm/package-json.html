...
<section id="content">
    ...
    <section id="table_of_contents">
        ...
        <div id="_table_of_contents">
            <ul>
                ...
                <ul>
                    <li><a href="#directoriesbin">directories.bin</a></li>
                    <li><a href="#directoriesman">directories.man</a></li>
                </ul>
                ...
                <ul>
                    <li><a href="#urls-as-dependencies">URLs as Dependencies</a></li>
                    <li><a href="#git-urls-as-dependencies">Git URLs as Dependencies</a></li>
                    <li><a href="#github-urls">GitHub URLs</a></li>
                    <li><a href="#local-paths">Local Paths</a></li>
                </ul>
                <li><a href="#devdependencies">devDependencies</a></li>
                <li><a href="#peerdependencies">peerDependencies</a></li>
                <li><a href="#peerdependenciesmeta">peerDependenciesMeta</a></li>
                ...
                <li><a href="#publishconfig">publishConfig</a></li>
  ...
  "license" : "BSD-3-Clause"
        ...
        <p>If your package is licensed under multiple common licenses, use an <a
                href="https://www.npmjs.com/package/spdx">SPDX
...
// Not valid metadata
{
  ...
  "config": {
    "port": "8080"
        ...
        <p>See <a href="https://github.com/npm/node-semver#versions">semver</a> for more details about specifying
            version ranges.</p>
        <ul>
            ...
            <li><code>^version</code> “Compatible with version” See <a
                    href="https://github.com/npm/node-semver#versions">semver</a></li>
            ...
            <li><code>tag</code> A specific version tagged and published as <code>tag</code> See <a
                    href="../commands/npm-dist-tag.html"><code>npm dist-tag</code></a></li>
  ...
  "dependencies": {
    ...
    "module": "user/repo#feature\/branch"
        ...
        <p>As of version 2.0.0 you can provide a path to a local directory that
            contains a package. Local paths can be saved using <code>npm install -S</code> or <code>npm install
                --save</code>, using any of these forms:</p>
  ...
  "peerDependencies": {
    "tea": "2.x"
        ...
        <p>This ensures your package <code>tea-latte</code> can be installed <em>along</em> with the
            second major version of the host package <code>tea</code> only. <code>npm install tea-latte</code> could
  ...
  "bundledDependencies": [
    ...
    "super-streams"
        ...
        <p>we can obtain <code>awesome-web-framework-1.0.0.tgz</code> file by running <code>npm pack</code>.
            ...
            can be installed in a new project by executing <code>npm install awesome-web-framework-1.0.0.tgz</code>.
        ...
        <p>If a dependency can be used, but you would like npm to proceed if it cannot
            ...
            failures do not cause installation to fail. Running <code>npm install --no-optional</code> will prevent
            these dependencies from being installed.</p>
