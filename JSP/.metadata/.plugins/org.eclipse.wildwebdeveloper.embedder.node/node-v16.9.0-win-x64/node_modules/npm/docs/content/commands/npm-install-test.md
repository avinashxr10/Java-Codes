---
title: npm-install-test section: 1 description: Install package(s) and run tests
---
...
This command runs an `npm install` followed immediately by an `npm test`. It takes exactly the same arguments
as `npm install`.
