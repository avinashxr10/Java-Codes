...
aliases: info, show, v
        ...
        <p>As an example, to view information about the <code>connect</code> package from the registry, you would run:
        </p>
        ...
        <p>You can view child fields by separating them with a period.
            To view the git repository URL for the latest version of <code>npm</code>, you would run the following
            command:</p>
        ...
        <p>“Person” fields are shown as a string if they would be shown as an
            ...
            the shortened string format. (See <a
                    href="../configuring-npm/package-json.html"><code>package.json</code></a> for more on this.)</p>
